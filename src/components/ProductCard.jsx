    ...
    <div className={`group bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-md transition duration-300 ${className}`}>
      ...
      <div className="p-5">
        <div className="flex justify-between items-start mb-2">
          <Link to={`/products/${product.id}`} className="hover:text-[#0e6655] transition">
        ...
        <div className="flex justify-between items-center">
          <span className="font-bold text-[#0e6655] text-lg">
            {product.price.toLocaleString('vi-VN')}đ
          </span>
          <button className="bg-[#0e6655] hover:bg-[#0d5a4a] text-white p-2 rounded-lg transition duration-300 group-hover:scale-110">
