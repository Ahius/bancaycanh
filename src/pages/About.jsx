export default function About() {
      ...
      <div className="container mx-auto px-4 py-12 md:py-16">
          ...
          <div className="flex flex-col md:flex-row gap-8 items-center">
            ...
            <div className="md:w-1/2">
              <h2 className="text-3xl font-bold text-gray-800 mb-6">
                <span className="text-[#0e6655]">Bạn của Lá</span> - Hành trình kết nối con người với thiên nhiên
              </h2>
              <p className="text-gray-600 leading-relaxed mb-6">
                Từ một tình yêu với cây xanh, chúng tôi đã xây dựng Bạn của Lá thành điểm đến tin cậy cho những ai muốn mang thiên nhiên vào không gian sống. Mỗi sản phẩm của chúng tôi là kết tinh của đam mê, kiến thức và sự tận tâm.
              </p>
              <div className="bg-green-50 p-6 rounded-lg border-l-4 border-[#0e6655]">
                <p className="italic text-gray-700">
                  "Mỗi cây xanh là một câu chuyện, mỗi không gian xanh là một tác phẩm nghệ thuật sống động"
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-16">
          <div className="flex flex-col md:flex-row-reverse gap-8 items-center">
            ...
            <div className="md:w-1/2">
              <h2 className="text-3xl font-bold text-gray-800 mb-6">Hành trình phát triển</h2>
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-semibold text-lg text-gray-800 mb-2">Khởi đầu (2015)</h3>
                    <p className="text-gray-600">
                      Từ một cửa hàng nhỏ với vài loại cây cảnh phổ biến, chúng tôi bắt đầu hành trình mang thiên nhiên đến gần hơn với mọi nhà.
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-semibold text-lg text-gray-800 mb-2">Mở rộng (2018)</h3>
                    <p className="text-gray-600">
                      Phát triển hệ thống vườn ươm riêng, nhập khẩu các giống cây độc đáo từ khắp nơi trên thế giới.
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-semibold text-lg text-gray-800 mb-2">Hiện tại</h3>
                    <p className="text-gray-600">
                      Trở thành địa chỉ tin cậy cho cây cảnh cao cấp, dịch vụ thiết kế không gian xanh và tư vấn phong thủy.
                    </p>
                  </div>
                </div>
              </div>
            ...
            {[
              {
                ...
                icon: (
                  <svg className="w-8 h-8 text-[#0e6655]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div key={index} className="bg-green-50 p-6 rounded-xl hover:bg-green-100 transition duration-300">
  ...
  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
    {[
      ...
      <div key={index} className="group bg-white rounded-lg shadow-sm overflow-hidden hover:shadow-md transition duration-300 flex flex-col h-full">
        {/* Image with fixed aspect ratio (3:4) */}
